...
const (
	// Standard width and height of a work image.
	StdWidth  = 240
	StdHeight = 80
...
// NewImage returns a new work image of the given width and height with the
...
func NewImage(id string, digits []byte, width, height int) *Image {
	...
	// Randomly position work inside the image.
...
// WriteTo writes work image in PNG format into the given writer.
